      ...
      <React.Fragment>
        ...
        <div className="our-mission">
          ...
          <span>
            ...
            site is processing your information based on applied law-making or
          ...
          <span>
            ...
            server and they are stored on your device. This is necessary because
            the second time you visit our web site, it will recognize your
            device. There are two types of cookies. The first one is called
            fixed and the second one - temporary or session cookies. The fixed
            cookies are stored on your device like files for a long period. The
            session cookies are stored when you are surfing on our web site but
            after you close the window, the cookie is gone. Most web sites are
          ...
          <span>
            ...
            information is transferred to the server where it is stored. You can
            stop this by making your browser settings not to save cookies. The
            processing of users data for analysis of internet traffic is making
            based on article 6, paragraph 1, word (a) and/or (e) GDPR. The
            legitimate interest of GDPR is based on making our web site function
            better. Our clients are the most important for us. That's why we
            appreciate our clients' personal information and the data we store
            for analysis of our web site traffic, was anonymized. In our web
            site, we maintain this data for 3 years.{" "}
          </span>
          <div className="section-row-between">
            <div className="line4"></div>
          </div>
